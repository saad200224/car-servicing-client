    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                <img src={bannerImage1} className="w-full rounded-lg" />
                <div className="rounded-lg absolute h-full flex items-center left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                ...
                <div className="absolute flex justify-end transform -translate-y-1/2 bottom-0 left-5 right-5">
            ...
            <div id="slide6" className="carousel-item relative w-full">
                <img src={bannerImage6} className="w-full rounded-lg" />
                <div className="absolute h-full flex items-center left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        <h2 className="text-6xl">Affordable Price For Car Servicing</h2>
                        <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
